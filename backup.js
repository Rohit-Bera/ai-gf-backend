...
const lipSyncMessage = async (message) => {
  ...
  // new Mp32Wav('./audios/api_0.mp3','./audios').exec();

  // this code converts mp3 to wav file
  await execCommand(
  ...
  if (!elevenLabsApiKey) {
    res.send({
      messages: [
        ...
        {
          text: "You don't want to ruin rohit bera with a crazy ElevenLabs bill, right?",
    ...
    messages: [
      {
        ...
        content: `
          ...
          You will always reply with a JSON array of messages. With a maximum of 3 relevant messages.
